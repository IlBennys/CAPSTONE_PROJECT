...
public class UtenteController {
    ...
    @GetMapping("/data/{l1}&{l2}")
    public ResponseEntity<?> findUtenteByDataNascita(@PathVariable LocalDate l1, @PathVariable LocalDate l2) {
	return new ResponseEntity<>(utenteService.findAllByDataNascita(l1, l2), HttpStatus.FOUND);
    }
